...
|gcc|*1.22685844*|1.29003928|**0.22957563**|
...
std::stable_sortには全勝したものの、std::sortに常勝するのが容易でないことが分かります。  
但し、環境や運用条件によっては、std::sortに勝る可能性も示せたと思います。  
