# 颯式(Hayate-Shiki)
颯式(Hayate-Shiki) is an improved merge sort algorithm with the goal of "faster than quick sort".  
...
"颯式" won all over std::stable_sort, but it turns out that it is not easy to win over std::sort.  
